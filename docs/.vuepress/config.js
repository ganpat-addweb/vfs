module.exports = {
  title: 'Vue Storefront 2 for addcom',
  base: '/',
  description: 'Documentation for the addcom connector for Vue Storefront 2',
  head: [
  ...
  themeConfig: {
    repo: 'https://github.com/vuestorefront/addcom',
    editLinks: true,
    docsDir: 'docs',
    docsBranch: 'develop',
    ...
    nav: [
      ...
      // { text: 'Demo', link: '' },
      { text: 'GitHub', link: 'https://github.com/vuestorefront/addcom'},
      { text: 'Roadmap', link: 'https://github.com/vuestorefront/addcom'}
    ],
    sidebar: [
      {
        title: 'Essentials',
